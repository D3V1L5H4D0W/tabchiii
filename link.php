...
$MadelineProto->messages->sendMessage(['peer' =>351587937,'message' => "ربات به یک گروه وارد شد",'parse_mode' => 'MarkDown']);
    } catch (\danog\MadelineProto\RPCErrorException $e) {
$MadelineProto->messages->sendMessage(['peer' =>351587937,'message' => "به دلیل محدودیت تلگرام ربات نتوانست وارد لینک شود",'parse_mode' => 'MarkDown']);
